...
from src.use_cases.report.generate_report_positions.generate_report_positions import GeneratePositionsReport
import unittest
...
class GeneratePositionsReportTest(unittest.TestCase):
    ...
    def test(self):
        ...
        generate_report = GeneratePositionsReport(generate_portfolio, None)
